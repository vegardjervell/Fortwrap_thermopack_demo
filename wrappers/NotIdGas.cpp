...
void NotIdGas::Fres(float T, float V, const std::vector<float>* n, float* Fres, float** Ft, float** Fv, float** Fn) {
  directeos__notidgas_fres_wrap(data_ptr, &T, &V, &(*n)[0], Fres, Ft, Fv, Fn);
}
