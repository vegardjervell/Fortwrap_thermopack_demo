...
using array_f = pybind11::array_t<float, pybind11::array::c_style | pybind11::array::forcecast>;using p_array_f = std::optional<pybind11::array_t<float, pybind11::array::c_style | pybind11::array::forcecast>>;
...
#define BaseEos_bindings(Model) \
    .def("Fideal", [](Model& self, float T, float V, const std::vector<float>* n, array_f Fid, p_array_f Ft, p_array_f Fv, p_array_f Fn){ \
            ...
            self.Fideal(T, V, n, Fid_bind, &Ft_bind, &Fv_bind, &Fn_bind); \
            }, py::arg("T")\
            , py::arg("V")\
            , py::arg("n")\
